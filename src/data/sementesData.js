...
export const sementesProducts = [
    {
        id: 1011,
        name: "Semente de Girassol",
        price: 9.00,
        oldPrice: 12.99,
        image: `${IMAGE_PATH}Sementes/Semente-Girassol.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-Girassol.jpg`,
            `${IMAGE_PATH}Sementes/Semente-Girassol.jpg`
        ],
        ...
        stock: 25,
        details: {
            light: "Sol pleno (mínimo 6 horas de sol direto)",
            water: "Regar diariamente no verão, mantendo o solo úmido",
            humidity: "Média umidade",
            temperature: "20°C a 30°C",
            care: "Plantar em solo bem drenado e fértil",
            toxicity: "Não tóxico"
        }
    },
    {
        ...
        price: 7.00,
        image: `${IMAGE_PATH}Sementes/semente-Lavanda.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/semente-Lavanda.jpg`,
            `${IMAGE_PATH}Sementes/semente-Lavanda.jpg`
        ],
    ...
    },
    {
        ...
        price: 7.00,
        image: `${IMAGE_PATH}Sementes/Semente-Tomates.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-Tomates.jpg`,
            `${IMAGE_PATH}Sementes/Semente-Tomates.jpg`
        ],
        ...
        details: {
            light: "Sol pleno",
            water: "Regar diariamente, mantendo o solo úmido",
            humidity: "Média umidade",
            temperature: "18°C a 28°C",
            care: "Adubar a cada 15 dias para melhor frutificação",
            toxicity: "Não tóxico"
        }
    },
    {
        ...
        price: 20.00,
        image: `${IMAGE_PATH}Sementes/Semente-Arvore.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-Arvore.jpg`,
            `${IMAGE_PATH}Sementes/Semente-Arvore.jpg`
        ],
        ...
        details: {
            light: "Sol pleno",
            water: "Regar 2x por semana, solo úmido",
            humidity: "Média umidade",
            temperature: "20°C a 35°C",
            care: "Solo fértil e bem drenado, adubar a cada 3 meses",
            toxicity: "Não tóxico"
        }
    },
    {
        ...
        price: 10.99,
        image: `${IMAGE_PATH}Sementes/Semente-Anturio.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-Anturio.jpg`,
            `${IMAGE_PATH}Sementes/Semente-Anturio.jpg`
        ],
    ...
    },
    {
        ...
        price: 22.50,
        image: `${IMAGE_PATH}Sementes/semente-samambaia.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/semente-samambaia.jpg`,
            `${IMAGE_PATH}Sementes/semente-samambaia.jpg`
        ],
        ...
        details: {
            ...
            care: "Borrifar água nas folhas regularmente",
            toxicity: "Não tóxico"
        }
    },
    {
        ...
        price: 27.00,
        image: `${IMAGE_PATH}Sementes/Semente-pitaya.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-pitaya.jpg`,
            `${IMAGE_PATH}Sementes/Semente-pitaya.jpg`
        ],
        ...
        details: {
            ...
            care: "Solo arenoso e bem drenado, adubar a cada 15 dias",
            toxicity: "Não tóxico"
        }
    },
    {
        ...
        price: 10.00,
        oldPrice: 12.99,
        image: `${IMAGE_PATH}Sementes/Semente-Aralia.jpg`,
        images: [
            `${IMAGE_PATH}Sementes/Semente-Aralia.jpg`,
            `${IMAGE_PATH}Sementes/Semente-Aralia.jpg`
        ],
        ...
        details: {
            ...
            care: "Adubar a cada 15 dias na primavera/verão",
            toxicity: "Não tóxico"
        }
    }
];